Name "dsp ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/dsplinz2019/dsplinz/issues"
!define UPDATEURL "https://github.com/dsplinz2019/dsplinz/releases"
...
# Install dsp binary
Section "Rlz" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Rlz}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\dsp.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\dsp.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Rlz incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Rlz outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Rlz UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Rlz incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\dsp.exe" "" "" "Dsplinz" 30303 "" "" ""
  SimpleFC::AdvAddRule "Rlz outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\dsp.exe" "" "" "Dsplinz" "" 30303 "" ""
  SimpleFC::AdvAddRule "Rlz UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\dsp.exe" "" "" "Dsplinz" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/dsplinz/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\dsp.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\dsp.ipc"
