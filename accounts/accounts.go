...
// Package accounts implements high level Dsplinz account management.
package accounts
...
// Account represents an Dsplinz account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Dsplinz account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain dsplinz.ChainStateReader)
