...
// Package bind generates Dsplinz contract Go bindings.
//
// Detailed usage document and tutorial available on the go-dsplinz Wiki page:
// https://github.com/dsplinz2019/dsplinz/wiki/Native-DApps:-Go-bindings-to-Dsplinz-contracts
package bind
