...
const (
	...
	MessageType_MessageType_DsplinzGetAddress       MessageType = 56
	MessageType_MessageType_DsplinzAddress          MessageType = 57
	MessageType_MessageType_DsplinzSignTx           MessageType = 58
	MessageType_MessageType_DsplinzTxRequest        MessageType = 59
	MessageType_MessageType_DsplinzTxAck            MessageType = 60
	...
	MessageType_MessageType_DsplinzSignMessage      MessageType = 64
	MessageType_MessageType_DsplinzVerifyMessage    MessageType = 65
	MessageType_MessageType_DsplinzMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_DsplinzGetAddress",
	57:  "MessageType_DsplinzAddress",
	58:  "MessageType_DsplinzSignTx",
	59:  "MessageType_DsplinzTxRequest",
	60:  "MessageType_DsplinzTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_DsplinzSignMessage",
	65:  "MessageType_DsplinzVerifyMessage",
	66:  "MessageType_DsplinzMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_DsplinzGetAddress":       56,
	"MessageType_DsplinzAddress":          57,
	"MessageType_DsplinzSignTx":           58,
	"MessageType_DsplinzTxRequest":        59,
	"MessageType_DsplinzTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_DsplinzSignMessage":      64,
	"MessageType_DsplinzVerifyMessage":    65,
	"MessageType_DsplinzMessageSignature": 66,
...
// *
// Request: Ask device for Dsplinz address corresponding to address_n path
// @next PassphraseRequest
// @next DsplinzAddress
// @next Failure
type DsplinzGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DsplinzGetAddress) Reset()                    { *m = DsplinzGetAddress{} }
func (m *DsplinzGetAddress) String() string            { return proto.CompactTextString(m) }
func (*DsplinzGetAddress) ProtoMessage()               {}
func (*DsplinzGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *DsplinzGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DsplinzGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Dsplinz address derived from device private seed
// @prev DsplinzGetAddress
type DsplinzAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DsplinzAddress) Reset()                    { *m = DsplinzAddress{} }
func (m *DsplinzAddress) String() string            { return proto.CompactTextString(m) }
func (*DsplinzAddress) ProtoMessage()               {}
func (*DsplinzAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *DsplinzAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next DsplinzTxRequest
// @next Failure
type DsplinzSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *DsplinzSignTx) Reset()                    { *m = DsplinzSignTx{} }
func (m *DsplinzSignTx) String() string            { return proto.CompactTextString(m) }
func (*DsplinzSignTx) ProtoMessage()               {}
func (*DsplinzSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *DsplinzSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DsplinzSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *DsplinzSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *DsplinzSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *DsplinzSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *DsplinzSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *DsplinzSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *DsplinzSignTx) GetDataLength() uint32 {
...
func (m *DsplinzSignTx) GetChainId() uint32 {
...
func (m *DsplinzTxRequest) Reset()                    { *m = DsplinzTxRequest{} }
func (m *DsplinzTxRequest) String() string            { return proto.CompactTextString(m) }
func (*DsplinzTxRequest) ProtoMessage()               {}
func (*DsplinzTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *DsplinzTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *DsplinzTxRequest) GetSignatureV() uint32 {
...
func (m *DsplinzTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *DsplinzTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev DsplinzTxRequest
// @next DsplinzTxRequest
type DsplinzTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DsplinzTxAck) Reset()                    { *m = DsplinzTxAck{} }
func (m *DsplinzTxAck) String() string            { return proto.CompactTextString(m) }
func (*DsplinzTxAck) ProtoMessage()               {}
func (*DsplinzTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *DsplinzTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next DsplinzMessageSignature
// @next Failure
type DsplinzSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *DsplinzSignMessage) Reset()                    { *m = DsplinzSignMessage{} }
func (m *DsplinzSignMessage) String() string            { return proto.CompactTextString(m) }
func (*DsplinzSignMessage) ProtoMessage()               {}
func (*DsplinzSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *DsplinzSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *DsplinzSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type DsplinzVerifyMessage struct {
...
func (m *DsplinzVerifyMessage) Reset()                    { *m = DsplinzVerifyMessage{} }
func (m *DsplinzVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*DsplinzVerifyMessage) ProtoMessage()               {}
func (*DsplinzVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *DsplinzVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DsplinzVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *DsplinzVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev DsplinzSignMessage
type DsplinzMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *DsplinzMessageSignature) Reset()                    { *m = DsplinzMessageSignature{} }
func (m *DsplinzMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*DsplinzMessageSignature) ProtoMessage()               {}
func (*DsplinzMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *DsplinzMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *DsplinzMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DsplinzGetAddress)(nil), "DsplinzGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*DsplinzAddress)(nil), "DsplinzAddress")
	...
	proto.RegisterType((*DsplinzSignTx)(nil), "DsplinzSignTx")
	proto.RegisterType((*DsplinzTxRequest)(nil), "DsplinzTxRequest")
	proto.RegisterType((*DsplinzTxAck)(nil), "DsplinzTxAck")
	proto.RegisterType((*DsplinzSignMessage)(nil), "DsplinzSignMessage")
	proto.RegisterType((*DsplinzVerifyMessage)(nil), "DsplinzVerifyMessage")
	proto.RegisterType((*DsplinzMessageSignature)(nil), "DsplinzMessageSignature")
