...
// Whisper represents a dark communication interface through the Dsplinz
...
// New creates a Whisper client ready to communicate through the Dsplinz P2P network.
