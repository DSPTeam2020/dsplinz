...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "dsp.ipc", false, filepath.Join(os.TempDir(), "dsp.ipc")},
		{"data", "dsp.ipc", false, "data/dsp.ipc"},
		{"data", "./dsp.ipc", false, "./dsp.ipc"},
		{"data", "/dsp.ipc", false, "/dsp.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "dsp.ipc", true, `\\.\pipe\dsp.ipc`},
		{"data", "dsp.ipc", true, `\\.\pipe\dsp.ipc`},
		{"data", `\\.\pipe\dsp.ipc`, true, `\\.\pipe\dsp.ipc`},
	}
