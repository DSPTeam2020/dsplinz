...
func defaultNodeConfig() node.Config {
	...
	cfg.HTTPModules = append(cfg.HTTPModules, "dsp", "shh")
	cfg.WSModules = append(cfg.WSModules, "dsp", "shh")
	cfg.IPCPath = "dsplinz.ipc"
	return cfg
}
...
func makeFullNode(ctx *cli.Context) *node.Node {
	...
	// Add the Dsplinz Stats daemon if requested.
	if cfg.Rlzstats.URL != "" {
