...
import (
	...
	"github.com/dsplinz2019/dsplinz/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Dsplinz contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Dsplinz contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Dsplinz contract Solidity source to build and bind")
