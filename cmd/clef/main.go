...
import (
	...
	"github.com/dsplinz2019/dsplinz/signer/core"
	"github.com/dsplinz2019/dsplinz/signer/rules"
	"github.com/dsplinz2019/dsplinz/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Dsplinz account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
