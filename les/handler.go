...
const (
	...
	ethVersion = 63 // equivalent dsp version for the downloader
...
// NewProtocolManager returns a new dsplinz sub protocol manager. The Dsplinz sub protocol manages peers capable
// with the dsplinz network.
...
// NodeInfo represents a short summary of the Dsplinz sub-protocol metadata
// known about the host peer.
type NodeInfo struct {
	Network    uint64              `json:"network"`    // Dsplinz network ID (1=Frontier, 2=Morden, Ropsten=3, Rinkeby=4)
