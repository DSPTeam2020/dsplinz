...
// It offers only mdspods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the Rlzereum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  dspereum.SyncProgress `json:"status"`
}
