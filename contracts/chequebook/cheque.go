...
// Package chequebook package wraps the 'chequebook' Dsplinz smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in dsp; (auto)cashing cheques in dsp
// as well as (auto)depositing dsp to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/dsplinz2019/dsplinz/contracts/chequebook/contract"
	"github.com/dsplinz2019/dsplinz/core/types"
	"github.com/dsplinz2019/dsplinz/crypto"
	"github.com/dsplinz2019/dsplinz/log"
	"github.com/dsplinz2019/dsplinz/swarm/services/swap/swap"
)
...
// * depositing dsp to the chequebook
// * watching incoming dsp
...
// Cash cashes the cheque by sending an Dsplinz transaction.
