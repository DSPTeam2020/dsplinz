...
func SetupGenesisBlock(db ethdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
		return params.AllRlzashProtocolChanges, common.Hash{}, errGenesisNoConfig
	}
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	default:
		return params.AllRlzashProtocolChanges
	}
}
...
func (g *Genesis) Commit(db ethdb.Database) (*types.Block, error) {
	...
	config := g.Config
	if config == nil {
		config = params.AllRlzashProtocolChanges
	}
...
// DefaultGenesisBlock returns the Dsplinz main net genesis block.
...
// DeveloperGenesisBlock returns the 'dsp --dev' genesis block. Note, this must
// be seeded with the
