...
type Context struct {
	...
	// sufficient dsp to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers dsp from one account to the other
...
// EVM is the Dsplinz Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) dsplinz virtual machine
