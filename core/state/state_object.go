...
// stateObject represents an Dsplinz account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of dsplinz address of the account
	data     Account
	db       *StateDB
...
// Account is the Dsplinz consensus representation of accounts.
