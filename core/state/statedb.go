...
// Package state provides a caching layer atop the Dsplinz state trie.
package state
...
// StateDBs within the dsplinz protocol are used to store anything
...
//
// Carrying over the balance ensures that Rlzer doesn't disappear.
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/dsplinz2019/dsplinz/pull/16485#issuecomment-380438527),
